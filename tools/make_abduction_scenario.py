...
BEATS = [
    ...
    od([
        ...
        ("cues", [
            od([("role", "actor"), ("steps", [
                # No `clearance` here, and that is ADR-262's first fix rather than a tidy-up.
        ...
        ("cues", [
            ...
            od([("role", "target"), ("steps", [
                ...
                od([("kind", "moveTo"), ("name", "lift"), ("to", "actor.beam"),
                    ...
                    # picture, and ADR-262 replaces both:
                    #
...
def apply(scene, staging=None):
    ...
    for node in scene["nodes"]:
        if node.get("name") == "visitor-beam":
            ...
            # large animal was wider than the beam lifting it (ADR-263).

// ADR-344: which background the scene pass draws, and the coupling that used to make that one
...
TEST_CASE("An HDRI can light the scene while the procedural sky stands behind it", "[sky][environment]") {
    ...
    // THE ARM. This is the configuration that had no expressible form before ADR-344.

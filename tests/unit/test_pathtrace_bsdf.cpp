// The glTF metallic-roughness BSDF and texture sampling (ADR-351 Phase 2, spec sections 18, 19).
//
...
TEST_CASE("a dielectric conserves energy except where the glTF model is known not to",
    ...
    // it worse, or a change which silently altered the model, both show up. See ADR-352.

...
TEST_CASE("PROBE the march's grain at matched luminance", "[.probe][volume][grain]") {
    ...
    const std::vector<Case> cases = {
        ...
        // ADR-713/714: the flow and colour review arms at the shipped 32 steps (generated by the
        // session's `make_ff_arms.py grain`; skipped when absent, like the arms above).
        {"ff-base-32", "examples/treeisland/_ff-flow-base-32.json", true, 6.0, -1, 0.0f},
        ...
        {"ff-colour-height-32", "examples/treeisland/_ff-colour-height-32.json", true, 6.0, -1, 0.0f},
        {"ff-colour-dist-32", "examples/treeisland/_ff-colour-distance-32.json", true, 6.0, -1, 0.0f},
    };

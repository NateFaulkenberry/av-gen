...
TEST_CASE("post/bloom/levels reaches the pyramid from a project (ADR-385)", "[gpu][post][bloom]") {
...
TEST_CASE("diag: auto-exposure adaptation curve through a step change", "[.adapt]") {
    // ADR-385's condition 2: the readback ring adds one frame of adaptation latency (frame N used

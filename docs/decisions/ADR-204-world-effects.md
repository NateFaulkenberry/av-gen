# ADR-204: World effects propagate through one frame-global block, not through per-object state
...
* The per-fragment cost measured in ADR-205 grows past the band recorded there on content with

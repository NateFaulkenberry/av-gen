# ADR-346: The denoiser ships as a prebuilt binary, because building it needs a compiler this project does not have

**Status:** Accepted
**Date:** 2026-09-18
**Amends:** ADR-344, which said this renderer would not bring oneTBB into the tree
...
## This amends ADR-344, which was wrong about TBB

ADR-344 states, of Embree: *"TBB is not used (`EMBREE_TASKING_SYSTEM=INTERNAL`), so no oneTBB

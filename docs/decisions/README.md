...
| [262](ADR-262-one-sphere-was-answering-two-questions.md) | One sphere was answering two questions, and a rung change drew nothing (the LOD / Geometry Lab: the ladder's own radius, the provable level range, the impostor predicate, and the rung overlay wired) | Accepted |

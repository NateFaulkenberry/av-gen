...
| [203](ADR-203-a-clip-starts-where-its-keys-start.md) | A clip starts where its keys start, a facing is not an odometer, and a stride speed is a claim about a clip | Accepted |

...
| [260](ADR-260-the-beam-is-a-column-not-an-axis-and-the-animal-is-not-its-origin.md) | The beam is a column, not an axis; the animal is not its origin; and the project was overriding the scene (the Tractor Beam Lab, `Anchor::Drawn`, `StepDesc::place`, and why three reported fixes never reached a render) | Accepted |

...
| [263](ADR-263-a-scene-file-is-not-the-state-that-runs.md) | A scene file is not the state that runs, and the entity layer was anchored before the project spoke (a project's 5,489 saved parameters, the beam that ran at 3.07 m, and the 28.661 m that was the diagonal) | Accepted |

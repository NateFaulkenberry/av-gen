...
| [278](ADR-278-the-blooms-reach-is-a-pixel-count.md) | The bloom's reach is a pixel count, so supersampling halves it -- measured, and not changed (r99 flat at 120 px across a fourfold range; 0.506 at renderScale 2 with a control that does not move) | Accepted |

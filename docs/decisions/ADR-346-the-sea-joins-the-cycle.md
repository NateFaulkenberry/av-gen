# ADR-346: The sea joins the cycle, and the fog stops arguing with the sky
...
environment *cube*, which is the HDRI: a fixed blue-sky map. Since ADR-344 made the visible sky

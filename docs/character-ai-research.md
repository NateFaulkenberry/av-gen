...
**Built 2026-09-18 as ADR-333** (`src/entity/decision.{hpp,cpp}`, the `decide` behaviour, four stock
...
- **Decide** (new, `IConsiderer`): a scored option list composed from several considerers, a
  ...
  ADR-333.** Four stock considerers; a guard and an explorer are the same C++ class with different

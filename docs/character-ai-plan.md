...
The fifth considerer nobody wrote is §P11, and it landed on 2026-09-18 as ADR-336.
...
### P12 — Foot IK  ·  needs P5 and P6  ·  one agent  ·  **done** (ADR-344)
...
**Landed 2026-09-18: ADR-336.** `RouteConsiderer` in `src/entity/decision.{hpp,cpp}`, a

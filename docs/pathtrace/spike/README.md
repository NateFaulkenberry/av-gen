...
Silicon before any engine code is written. Kept in the tree because the conclusions in ADR-340 are
...
Embree 4.4.0 does not compile as C++23 under Apple clang 21. See ADR-340.

...
- **`navigation` is how a layer overrules the obstacle heuristic** (ADR-196): `"auto"` (the
...
derived from its own height and type by `entity::traversalClass` (ADR-196). What a particular body

...
| Comet | **ADR-230** `EffectKind::Comet`, great-circle arc, core/halo/tail/sparkle/rainbow + ground illumination. Already authored here as `atmos/Bioluminescent Comet/*`. | Keep. It is good and the spec says so. |

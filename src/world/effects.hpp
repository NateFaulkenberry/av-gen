...
// World effects (ADR-204): a spatial phenomenon propagating through the world.
//
...
// How much of the effect a surface takes. See ADR-204's consequences: these are the classes the
...
// Mirrors `WorldEffect` in shaders/world_effects.wgsl. 144 bytes; see ADR-204 for why it lives in

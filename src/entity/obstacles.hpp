...
struct ObstaclePolicy {
    ...
    // Where the traversal classes fall, in metres of solid (ADR-194). These describe the *thing*,
...
// What getting past a solid of this identity and this height takes (ADR-194). Identity still only

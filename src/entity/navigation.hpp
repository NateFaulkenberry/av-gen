...
struct NavSettings {
    ...
    // Metres of solid this body can clear by vaulting (ADR-196). Only `spatial::Traversal::Jumpable`
...
public:
    ...
    // (ADR-335). Two of these, differing only in `NavPathCost::wadePenalty`, are the two ways

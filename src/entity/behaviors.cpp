...
// **Walking out of a crowd, for anything that stands on the ground (ADR-240, ADR-338).**
//
...
public:
    ...
    void update(const BehaviorContext& ctx, EntityState& state, MotionOffset& motion) override {
        ...
        // **The stall breaker (ADR-338), off unless a scene asks for it.**
        //

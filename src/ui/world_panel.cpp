...
void WorldPanel::drawOverview(app::Engine& engine) {
    ...
    // ADR-383: the composition's own nodes -- the things somebody placed and named. This list was
...
void WorldPanel::drawInspector(app::Engine& engine) {
    ...
    // ADR-383: the selected object's own controls, editable, grouped by the sub-prefix the

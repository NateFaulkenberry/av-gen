...
// Authored settings for the temporal effect family (ADR-410, brief §9-§17).
//
...
// ADR-410 forbids outright -- and because "I forgot to declare a bound" does not fail to compile,

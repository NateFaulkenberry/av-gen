...
// Conformance for the temporal effect family (ADR-410, and ADR-392's mechanism).
//
// **What this is for.** ADR-410's whole argument rests on one promise: no temporal effect is an
...
//      can hold". Both are the accumulator ADR-410 forbids, arriving by different routes.

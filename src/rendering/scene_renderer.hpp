...
struct RenderStats {
    ...
    PostStats post;
    TemporalStats temporal;     // ADR-394; ring occupancy, settling state, and what it costs
...
private:
    ...
    // ADR-394. Runs between the scene pass and the post chain: captures the clean scene radiance
